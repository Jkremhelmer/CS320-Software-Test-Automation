...
class ContactServiceTest {
	...
	/**
	 * call AddContact passing the first, last, phone, address then validate it
	...
	*/
	...
	void testEditPhone() {
		...
		test.editNumber("0", "3841256837");
		assertEquals("3841256837", ContactService.contactList.get(0).getPhoneNumber());
	}
	/**
