...
class ApptServiceTests {
	...
	@DisplayName("Add a bad Appointment with empty desc")
	@Test
	...
	@DisplayName("Add a bad Appointment with null desc")
	@Test
	...
	/*
	 * Add 3 contacts via addAppt delete object at ID 1 check that object is not present
	 */
	...
	/*
	 * create an appointment and then update with good ID
	 */ 
	  @DisplayName("Test updateAppt with a good ID")
	  	@Test 
	  	void testUpdateappointments() {
		  String id = "0";
		  String description ="This is a good description";
		  Calendar c = Calendar.getInstance();
	...
	/*
	 * create an appointment and then update with bad ID
	 */
	
	 @DisplayName("Test updateTask with a bad ID")
	 	@Test 
	 	void testBadUpdateappointments() {
		 String id = "0";
		 String description= "This is a good description";
		 Calendar c = Calendar.getInstance();
